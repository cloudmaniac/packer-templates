/*
    DESCRIPTION: Ubuntu 18.04 LTS (Bionic Beaver) vSphere template.
...
source "vsphere-iso" "ubuntu" {
  ...
  boot_command         = ["<esc><wait>", "<esc><wait>", "<enter><wait>", "/install/vmlinuz", " initrd=/install/initrd.gz", " auto=true", " priority=critical", " debian-installer=en_US", " locale=en_US", " kbd-chooser/method=us", " keyboard-configuration/modelcode=SKIP keyboard-configuration/layout=USA console-setup/ask_detect=false", " file=/media/preseed.cfg", "<enter>"]
  boot_wait            = "5s"
